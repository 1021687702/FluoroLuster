...
--%>
      ...
      <%--              <c:forEach var="product" items="${products}" varStatus="i" >--%>
                    ...
                    <tr>
                        <td colspan="3" align="left" bgcolor="#FFFFFF" class="about-font"><span class="about-font-en"><strong>产品信息：</strong>功能型含氟树脂溶液，针对高端制造业应用需求，提供订制化材料解决方案及相关产品。我司T系列含氟树脂溶液，目前提供三种型号：T8、T6、T3,分别适应不同应用场景，并提供基于特殊应用需求的材料订制化服务。 </span> </td>
                    </tr>
                    <tr>
